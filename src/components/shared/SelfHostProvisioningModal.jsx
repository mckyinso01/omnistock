...
import { ShieldCheck, Key, HardDrive, Trash2, Server, CheckCircle2, AlertTriangle, ArrowRight, Loader2, Lock, Eye, EyeOff } from "lucide-react";
      ...
      <div className="bg-slate-900 border border-emerald-500/30 rounded-2xl max-w-xl w-full p-6 text-slate-100 shadow-2xl space-y-6 text-left relative overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">OmniStock Self-Host Provisioning</h2>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-3 pr-10 py-2 rounded-lg bg-slate-950 border border-slate-800 text-base sm:text-xs text-slate-200 outline-none focus:border-[#00E5FF] font-mono"
                    />
                    <button
                      type="button"
        ...
        {step === 3 && success && (
          <div className="space-y-6 text-center py-4">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-black text-white">OmniStock POS Initialized!</h3>
